...
\begin{document}
	...
	\begin{titlepage}
		...
		{\normalsize\bfseries Versión del documento:} 3.1\\[4pt]
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{@{}l l l X@{}}
			...
			3.1 & 09/08/2026 & Equipo MundiPets & PE4 (Unidad IV): incorpora RF-26 (RFC-01, eliminación de cuenta y datos personales), acota RNF-02 al entorno de producción (RFC-02), formaliza el canal de respaldo en RF-10 (RFC-03), y corrige los 18 defectos detectados en la inspección formal Fagan (Sección 4 del informe PE4). \\
			\bottomrule
		\end{tabularx}
	\end{table}
	...
	\begin{atributos}{RF-01}{RF-01 --- Registrar mascota.}
		Identificador & RF-01 \\
		Nombre & Registrar mascota \\
		Descripción & El sistema deberá permitir al propietario registrar una mascota ingresando su información general, incluyendo nombre, especie, raza, sexo, edad, estado reproductivo, una descripción libre de su temperamento o características particulares, y fotografías para su identificación dentro de la plataforma. \\
	...
	\begin{atributos}{RF-02}{RF-02 --- Gestionar historial médico de la mascota.}
		...
		Entradas & Vacunas (fecha de aplicación, cepa, aplicador), desparasitaciones, enfermedades, alergias, cirugías, tratamientos, controles médicos, observaciones. \\
	...
	\begin{atributos}{RF-05}{RF-05 --- Gestionar solicitudes de adopción.}
		...
		Descripción & El sistema deberá permitir que un usuario interesado envíe solicitudes de adopción, incluyendo su fotografía de perfil, y que el propietario o el refugio de animales responsable de la mascota puedan aceptarlas o rechazarlas después de revisar la información del solicitante. \\
		Actor & Adoptante, Propietario de mascota, Refugio de animales \\
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Registrar una solicitud y comprobar que el propietario o el refugio responsable pueden visualizar el perfil del solicitante y gestionarla correctamente. \\
	\end{atributos}
	...
	\begin{atributos}{RF-10}{RF-10 --- Gestionar recordatorios de controles preventivos.}
		...
		Descripción & El sistema deberá generar recordatorios por notificación en la aplicación y WhatsApp para informar al propietario sobre próximas vacunas, desparasitaciones y controles veterinarios, enviándolos con una semana y un día de anticipación. Ante la indisponibilidad del proveedor externo de mensajería (WhatsApp Business API), el sistema deberá garantizar el recordatorio mediante el canal de respaldo in-app, conforme a RD-08. \\
		Actor & Propietario de mascota \\
		Origen (ID de evidencia) & EV-02, EV-04, EV-06, EV-11 \\
		Entradas & Fechas de vacunas, controles veterinarios y desparasitaciones. \\
		Salidas & Notificaciones o recordatorios generados por el sistema en los dos momentos definidos, por WhatsApp o, en caso de falla del proveedor, por el canal de respaldo in-app. \\
		Precondiciones & Deben existir fechas registradas para los controles preventivos de la mascota. \\
		Postcondiciones & El propietario recibe el recordatorio correspondiente antes de la fecha programada, a través de al menos uno de los dos canales disponibles. \\
		Prioridad (MoSCoW) & Should \\
		Criterio de verificación & Registrar una fecha de vacunación próxima y verificar que el sistema genere el recordatorio una semana y un día antes; simular la indisponibilidad de WhatsApp y comprobar que el recordatorio se entrega igualmente por el canal in-app. \\
	\end{atributos}
	...
	\begin{atributos}{RF-12}{RF-12 --- Verificar la identidad de los usuarios.}
		...
		Descripción & El sistema deberá permitir verificar la identidad de los usuarios mediante el registro y validación de la información requerida antes de participar en procesos de adopción o cruza. Cuando el rol seleccionado sea Veterinaria, la verificación deberá incluir además la validación del número de registro profesional ante el ente regulador competente. \\
		Actor & Propietario de mascota, Adoptante, Interesado en cruza, Veterinaria \\
		Origen (ID de evidencia) & EV-01, EV-03, EV-07, EV-08, EV-09 \\
		Entradas & Información de identificación del usuario; para el rol Veterinaria, número de registro profesional ante el ente regulador competente. \\
		Salidas & Usuario verificado dentro de la plataforma. \\
		Precondiciones & El usuario debe haber iniciado el proceso de registro. \\
		Postcondiciones & El usuario obtiene el estado de identidad verificada; para el rol Veterinaria, el sistema marca el registro como validado profesionalmente conforme a RD-03. \\
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Registrar un usuario con la documentación requerida y verificar que el sistema indique correctamente el estado de verificación; para el rol Veterinaria, comprobar que el sistema exige y valida el número de registro profesional. \\
	\end{atributos}
	...
	\begin{atributos}{RF-18}{RF-18 --- Gestionar el flujo de solicitud de adopción por etapas.}
		...
		Entradas & Formulario de solicitud, resultado de entrevista, resultado de visita al hogar, resultado de periodo de prueba, compromiso firmado. \\
	...
	\subsubsection{RF-26 --- Eliminar cuenta y datos personales}
	
	\begin{atributos}{RF-26}{RF-26 --- Eliminar cuenta y datos personales.}
		Identificador & RF-26 \\
		Nombre & Eliminar cuenta y datos personales \\
		Descripción & El sistema deberá permitir al propietario solicitar la eliminación de su cuenta y de sus datos personales asociados. Una vez confirmada la solicitud, el sistema ejecutará la supresión o anonimización de dichos datos dentro de un plazo definido, conservando únicamente la información cuya retención sea legalmente obligatoria, y dejará un registro de auditoría de la solicitud y de su ejecución. \\
		Actor & Propietario de mascota \\
		Origen (ID de evidencia) & RL-04, RD-06 \\
		Entradas & Solicitud de eliminación, confirmación de identidad del propietario. \\
		Salidas & Confirmación de eliminación o anonimización, registro de auditoría de la solicitud. \\
		Precondiciones & El propietario debe estar autenticado en el sistema. \\
		Postcondiciones & La cuenta y los datos personales asociados quedan eliminados o anonimizados según corresponda; el historial médico compartido con veterinarias o refugios se trata conforme a la política de retención definida para RD-06. \\
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Solicitar la eliminación de una cuenta de prueba y comprobar que, dentro del plazo definido, los datos personales quedan suprimidos o anonimizados, y que el registro de auditoría de la solicitud queda disponible. \\
	\end{atributos}
	...
	\begin{atributos}{RNF-02}{RNF-02 --- Disponibilidad del sistema.}
		...
		Descripción & El sistema deberá mantenerse disponible para los usuarios con una disponibilidad mínima del 99\,\% mensual, permitiendo el acceso continuo a sus funcionalidades durante la operación normal de la plataforma. Este criterio aplica al entorno de producción con backend desplegado; no es exigible ni medible sobre el MVP local descrito en la Sección~6, que opera con almacenamiento local (\texttt{localStorage}) sin servidor. \\
		Métrica & Porcentaje de disponibilidad mensual (entorno de producción). \\
		Valor objetivo & $\geq$ 99\,\% de disponibilidad mensual en producción. \\
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Monitorear la disponibilidad del sistema en el entorno de producción durante un mes de operación y comprobar que cumple el porcentaje establecido. No aplica al MVP local. \\
	\end{atributos}
	...
	\begin{atributos}{RNF-04}{RNF-04 --- Facilidad de uso de la plataforma.}
		...
		Prioridad (MoSCoW) & Should \\
		Criterio de verificación & Realizar pruebas de usabilidad con una muestra mínima de 15 usuarios representativos (sin experiencia previa con la plataforma), medir el porcentaje de finalización sin ayuda y aplicar el cuestionario SUS al finalizar. \\
	\end{atributos}
	...
	\begin{atributos}{RNF-11}{RNF-11 --- Portabilidad entre navegadores y dispositivos.}
		...
		Descripción & La plataforma web deberá funcionar correctamente en los navegadores Chrome, Firefox, Safari y Microsoft Edge (dos últimas versiones estables) y adaptarse de forma responsiva a pantallas móviles y de escritorio. \\
		Métrica & Porcentaje de funcionalidades Must que operan sin errores por navegador/dispositivo probado. \\
		Valor objetivo & 100\,\% de las funcionalidades Must operativas en los 4 navegadores y en resolución móvil y de escritorio. \\
		Prioridad (MoSCoW) & Should \\
	...
	\begin{atributos}{RNF-13}{RNF-13 --- Explicabilidad de la recomendación de compatibilidad para cruza (RF-06).}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Solicitar una evaluación de compatibilidad, comprobar tiempo/extensión de la explicación y aplicar una encuesta de comprensión ($\geq$ 4/5 de calificación media) a una muestra mínima de 15 usuarios (10 no técnicos, 5 técnicos). \\
	\end{atributos}
	...
	\begin{atributos}{RNF-14}{RNF-14 --- Explicabilidad del rechazo o aceptación de imágenes (RF-17).}
		...
		Prioridad (MoSCoW) & Should \\
		Criterio de verificación & Cargar imágenes inválidas, comprobar que cada rechazo muestra un motivo específico, y encuestar la comprensión del motivo mostrado a una muestra mínima de 15 usuarios (10 no técnicos, 5 técnicos). \\
	\end{atributos}
	...
	\begin{atributos}{RNF-15}{RNF-15 --- Explicabilidad de la moderación de mensajes.}
		...
		Prioridad (MoSCoW) & Should \\
		Criterio de verificación & Enviar mensajes de prueba con contenido inapropiado y comprobar que se muestra la categoría de infracción antes de bloquear el envío; encuestar la comprensión de la notificación a una muestra mínima de 15 usuarios (10 no técnicos, 5 técnicos). \\
	\end{atributos}
	...
	\begin{atributos}{RNF-16}{RNF-16 --- Confidencialidad de datos de ubicación y contacto.}
		...
		Característica ISO 25010 & Seguridad \\
		Descripción & El sistema deberá ocultar por defecto la ubicación exacta y los datos de contacto directo del propietario, mostrando únicamente una zona aproximada (radio entre 1 km y 5 km, configurable por el propietario dentro de ese rango) a usuarios no autorizados, en cumplimiento del principio de minimización de la LOPDP. \\
	...
	datos son objeto de tratamiento; el titular de derechos es siempre el propietario
	(persona natural), no la mascota. El historial médico de la mascota no constituye,
	en sí mismo, un dato personal directo, pero queda protegido de forma indirecta
	cuando permite identificar información sobre el propietario --- ubicación, hábitos,
	capacidad económica o comportamiento ---, en concordancia con el tratamiento que
	RL-07 da al historial clínico como extensión indirecta de los datos del propietario.
	La Tabla~\ref{tab:legales} traza cada artículo de la ley hasta el requisito que lo
	implementa.
	...
	\begin{atributos}{RD-01}{RD-01 --- Integración de componentes de inteligencia artificial.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Verificar que el módulo de compatibilidad y el de validación de imágenes generan una respuesta basada en el componente de IA correspondiente, y no en una regla estática, para una muestra de al menos 10 casos de prueba. \\
	\end{atributos}
	...
	\begin{atributos}{RD-02}{RD-02 --- Acceso basado en roles.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Iniciar sesión con cada rol (propietario, veterinaria, administrador) y comprobar que cada uno accede únicamente a las funciones y datos permitidos para su rol. \\
	\end{atributos}
	...
	\begin{atributos}{RD-03}{RD-03 --- Validación profesional de la información médica.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Registrar información médica desde una cuenta sin rol Veterinaria y comprobar que el sistema la marca como no validada profesionalmente; repetir desde una cuenta con rol Veterinaria y comprobar que queda marcada como validada. \\
	\end{atributos}
	...
	\begin{atributos}{RD-04}{RD-04 --- Protección de datos personales.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Intentar acceder a datos personales o clínicos sin autenticación o autorización adecuada y comprobar que el sistema deniega el acceso, conforme al principio de protección de datos desde el diseño y por defecto. \\
	\end{atributos}
	...
	\begin{atributos}{RD-05}{RD-05 --- Arquitectura modular del sistema.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Verificar que los módulos del sistema (gestión de mascotas, adopción, cruza, IA) están desacoplados en el código fuente, de modo que la modificación de uno no requiera cambios en los demás. \\
	\end{atributos}
	...
	\begin{atributos}{RD-06}{RD-06 --- Mecanismo de eliminación de cuenta y datos personales.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Solicitar la eliminación de una cuenta de prueba y comprobar que, dentro del plazo definido, los datos personales quedan suprimidos o anonimizados según corresponda. \\
	\end{atributos}
	...
	\begin{atributos}{RD-07}{RD-07 --- Protocolo de notificación de vulneraciones de seguridad.}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Simular un incidente de seguridad y comprobar que el sistema genera el registro correspondiente y que el procedimiento de notificación puede ejecutarse dentro de los plazos de 5 y 3 días establecidos. \\
	\end{atributos}
	...
	\begin{atributos}{RD-08}{RD-08 --- Dependencia de servicios externos de mensajería.}
		...
		Prioridad (MoSCoW) & Should \\
		Criterio de verificación & Simular la indisponibilidad del proveedor externo de mensajería y comprobar que el sistema entrega el recordatorio mediante el canal de respaldo in-app, conforme a RF-10. \\
	\end{atributos}
	...
	\begin{atributos}{RD-09}{RD-09 --- Anonimización de evidencias de campo para publicación abierta (nueva).}
		...
		Prioridad (MoSCoW) & Must \\
		Criterio de verificación & Revisar una muestra de transcripciones, videos y respuestas incluidas en el conjunto de datos abierto, y comprobar que no contienen identificadores directos del propietario. \\
	\end{atributos}
	...
	\begin{atributos}{HU-11}{HU-11 --- Historia de usuario asociada al RF-14.}
		...
		Pequeña (S) & Cubre el registro y consulta del carnet; la trazabilidad de cepa y lote (RF-24, Must) se implementa como incremento posterior de esta misma historia. \\
	...
	\begin{lstlisting}[style=gherkin,caption={CA-14 --- Escenario de aceptación de la historia HU-14.},label={lst:ca14}]
		...
		Entonces el sistema rechaza la operacion
		Y muestra el mensaje "No es posible registrar seguimiento: la adopcion aun no ha sido completada"
	\end{lstlisting}
	...
	\begin{longtable}{@{}p{1.6cm} p{4.8cm} p{1.6cm} p{5.2cm}@{}}
		...
		\hline
		RF-04 & Buscar y filtrar mascotas & Should & Mejora la usabilidad; aunque su media de importancia declarada es alta (4,16/5), el porcentaje de calificación máxima es el más bajo del grupo evaluado (42,1\,\%), por lo que el sistema puede operar inicialmente con listas generales. \\
		\hline
		...
		\hline
		RF-24 & Trazabilidad de cepa, lote y aplicador & Must & Dependencia bloqueante del paso 4 de CU-02, que exige registrar estos datos como parte obligatoria del flujo. \\
		\hline
	...
	\textbf{la matriz completa, con sus 59 filas (TR-01 a TR-59), se presenta en
	...
	La matriz cubre los 59 requisitos vigentes especificados en este documento:
	los 25 requisitos funcionales, los 16 no funcionales, las 9 restricciones de
	diseño y los 9 requisitos legales, estos últimos enlazados hacia la
	restricción de diseño (RD) que los implementa, conforme a la Tabla~\ref{tab:legales}.
	Cada fila parte de al menos una evidencia del catálogo del
	Apéndice~B.1, de modo que ningún requisito queda sin respaldo empírico. De
	las 59 filas, 22 declaran una obligación legal explícita de la LOPDP con su
	...
	\begin{table}[H]
		\centering
		\caption{Estructura de la matriz de trazabilidad extendida (formato de las 59 filas del Apéndice~D).}
	...
	\begin{longtable}{@{}p{1.5cm} p{5.2cm} p{1.7cm} p{3.0cm} p{3.4cm}@{}}
		...
		\hline
		RF-24 & Registrar trazabilidad de cepa, lote y aplicador de cada vacuna & Must & No implementado & --- \\
		\hline
	...
	\begin{landscape}
		\begin{longtable}{@{}p{1.2cm} p{5.2cm} p{1.0cm} p{1.3cm} p{1.3cm} p{1.1cm} p{6.5cm}@{}}
			...
			RF-24 & Trazabilidad de cepa, lote y aplicador & RF & Must & Alta (4,71) & 2,67 & Dependencia bloqueante del paso 4 de CU-02 (Must), que exige estos datos como parte obligatoria del flujo. \\ \midrule
	...
	alcanza las \textbf{59 filas} (TR-01 a TR-59), por encima del mínimo de 40
	exigido: las veinte filas TR-31 a TR-50 recogen las relaciones
	derivadas de los RF-18 a RF-25, de los RNF-09 a RNF-16 y de los RD-06 a RD-09
	incorporados o completados en esta entrega, y las nueve filas finales
	(TR-51 a TR-59) enlazan cada requisito legal (RL-01 a RL-09) con la
	restricción de diseño que lo implementa. Con ello, la totalidad de los 25
	RF, los 16 RNF, las 9 RD y los 9 RL del documento queda trazada.

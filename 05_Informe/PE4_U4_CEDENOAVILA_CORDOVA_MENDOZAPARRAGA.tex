...
Con la aprobación de las tres RFC, el ERS transita de la versión \texttt{v1.0} a la versión \texttt{v1.1}. Esta nueva versión incorpora: (i) las correcciones de los 18 defectos documentadas en la Sección~4; (ii) el nuevo RF-26 aprobado por RFC-01; (iii) la redacción acotada de RNF-02 aprobada por RFC-02; y (iv) la formalización del canal de respaldo en RF-10 aprobada por RFC-03.

La coherencia de versión se mantiene entre los siguientes artefactos: la portada y el historial de revisiones del documento \texttt{ERS\_SRS\_2A\_v1.1}, el archivo \texttt{CHANGELOG.md} del repositorio (entrada \texttt{[1.1]}) y el tag anotado \texttt{baseline-v1.1} publicado en el repositorio Git, conforme se detalla en la Sección~7.
	% ============================================================
